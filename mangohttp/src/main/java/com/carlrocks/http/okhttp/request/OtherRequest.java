...
import com.carlrocks.http.okhttp.utils.Exceptions;
...
public class OtherRequest extends OkHttpRequest
{
    ...
    {
        if (method.equals(MangoHttpUtils.METHOD.PUT))
        {
            builder.put(requestBody);
        } else if (method.equals(MangoHttpUtils.METHOD.DELETE))
        {
            if (requestBody == null)
                builder.delete();
            else
                builder.delete(requestBody);
        } else if (method.equals(MangoHttpUtils.METHOD.HEAD))
        {
            builder.head();
        } else if (method.equals(MangoHttpUtils.METHOD.PATCH))
        {
